    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const errorData = await response.json();
                alert(`Error registering family: ${errorData.error || "Unknown error"}`);
            }
        } catch (error) {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-purple-900 to-indigo-900">
            <div className="max-w-2xl w-full bg-gradient-to-br from-purple-700 to-indigo-700 p-8 rounded-lg shadow-lg text-white">
                ...
                <div className="mb-6">
                    <label className="block text-sm font-medium mb-2">Enter Primary Patient Email</label>
                    <div className="flex">
                        <input
                            type="text"
                    ...
                    {primaryPatient && (
                        <div className="bg-green-600 p-4 rounded-md mt-4">
                            ...
                            <p>{primaryPatient.first_name} {primaryPatient.last_name}</p>
